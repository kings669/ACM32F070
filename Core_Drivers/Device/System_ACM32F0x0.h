...
typedef enum
{
    LVD_TRIM_171   = 0x00U,   // 1.71v
    LVD_TRIM_201   = 0x01U,   // 2.01v
    LVD_TRIM_223   = 0x02U,   // 2.23v
    LVD_TRIM_243   = 0x03U,   // 2.43v
    LVD_TRIM_251   = 0x04U,   // 2.51v
    LVD_TRIM_273   = 0x05U,   // 2.73v
    LVD_TRIM_280   = 0x06U,   // 2.80v
    LVD_TRIM_290   = 0x07U,   // 2.90v 
}LVD_TRIM_ENUM; 

typedef enum
{
 FLTCLK_SEL_PCLK_32    = 0x00U,   //=PCLK/32
 FLTCLK_SEL_RC32k      = 0x01U,   //=RC32K
}LVD_CMP_FLTCLK_SEL_ENUM; 

typedef enum
{
    LVD_FLT_TIME_1      = 0x00U,   
    LVD_FLT_TIME_2      = 0x01U,   
    LVD_FLT_TIME_4      = 0x02U,   
    LVD_FLT_TIME_16     = 0x03U,   
    LVD_FLT_TIME_64     = 0x04U,   
    LVD_FLT_TIME_256    = 0x05U,   
    LVD_FLT_TIME_1024   = 0x06U,  
    LVD_FLT_TIME_4095   = 0x07U,   
}LVD_FLT_TIME_ENUM; 
...
FUNC_DISABLE_ENABLE      LVDEN;  //Enable or Disable LVD
    
LVD_TRIM_ENUM            LVD_TRIM; //set LVD TRIM 
    
FUNC_DISABLE_ENABLE      LVD_FLTEN; //Enable or Disable LVD_FLT
    
LVD_FLT_TIME_ENUM        LVD_FLT_TIME;//set LVD FLTT IME
    
LVD_CMP_FLTCLK_SEL_ENUM  LVD_FLTCLK_SEL; //set LVD FLTCLK SEL
    
FUNC_DISABLE_ENABLE      LVDRST_EN; //Enable or Disable LVDRST
...
/* System_LVD_Config */    
void System_LVD_Config(LVD_InitTypeDef* LVD_Init)  ;  
